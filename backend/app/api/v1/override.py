...
from app.services.episode_service import get_episode_by_date, save_override
...
async def submit_override(data: OverrideRequest):
    ...
    episode = save_override(
        date=data.date,
        original_value=data.original_value,
        replaced_value=data.replaced_value,
        reason=data.reason,
        confirmation_answers=data.confirmation_answers,
        override_by="user",
    )
