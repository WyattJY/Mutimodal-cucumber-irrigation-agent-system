# `backend/ultralytics/models/yolo/pose` 目录说明
...
- 路径: `backend/ultralytics/models/yolo/pose/__init__.py`
...
### `predict.py`
- 作用/意义: A class extending the DetectionPredictor class for prediction based on a pose model.
- 路径: `backend/ultralytics/models/yolo/pose/predict.py`
...
### `train.py`
- 作用/意义: A class extending the DetectionTrainer class for training based on a pose model.
- 路径: `backend/ultralytics/models/yolo/pose/train.py`
...
### `val.py`
- 作用/意义: A class extending the DetectionValidator class for validation based on a pose model.
- 路径: `backend/ultralytics/models/yolo/pose/val.py`
