...
class Model(nn.Module):
    ...
    def val(
        ...
        **kwargs: Any,
        ...
        args = {**self.overrides, **custom, **kwargs, "mode": kwargs.get('mode')}  # highest priority args on the right
    ...
    def train(
        ...
        **kwargs: Any,
        ...
        args = {**overrides, **custom, **kwargs, "mode": kwargs.get('mode')}  # highest priority args on the right
        if args.get("resume"):
